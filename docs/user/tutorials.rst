...
* `MNIST with scikit-learn and skorch <https://github.com/dnouri/skorch/blob/master/examples/MNIST/MNIST.ipynb>`_ - Define and train a simple neural network with PyTorch and use it with skorch.

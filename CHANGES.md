...
- Added support for creating model checkpoints on Hugging Face Hub using [`HfHubWriter`](https://skorch.readthedocs.io/en/latest/hf.html#skorch.hf.HfHubWriter)

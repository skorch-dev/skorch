...
class TestTrimForPrediction:
    ...
    def trim_for_prediction(self):
        from skorch.helper import trim_for_prediction
    ...
    def test_try_training_trimmed_net(self):
        # TODO
        pass
    ...
    def test_criteria_trimmed(self, net, trim_for_prediction):
        trim_for_prediction(net)
        assert net.criterion is None
        assert net.criterion_ is None
        assert net.criterion2_ is None

    def test_criteria_left_untrimmed(self, net, trim_for_prediction):
        trim_for_prediction(net, trim_criterion=False)
        assert net.criterion is not None
        assert net.criterion_ is not None
        assert net.criterion2_ is not None

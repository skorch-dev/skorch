...
class TestSkorchDoctorSimple:  # pylint: disable=too-many-public-methods
    ...
    def test_callbacks_cleaned_up_after_fit_with_initial_callbacks(self, doctor_cls, net_cls, module_cls, data):
    ...
    def test_recs_with_filter_no_match(self, module_cls, net_cls, doctor_cls, data, custom_split):
        ...
        msg = "No activations, gradients, or updates are being recorded, " "please check the match_fn"
    ...
    def test_plot_not_fitted_raises(self, plt, doctor_cls, net_cls, module_cls):
        ...
        msg = r"SkorchDoctor is not initialized yet. Call 'fit\(X, y\) before using this " "method."
    ...
    def test_plot_activations_over_time_no_match(self, plt, doctor):
        msg = r"No layer named 'foo' could be found. " r"Use doctor.get_layer_names\(\) to check all layers."
    ...
    def test_plot_gradient_over_time_no_match(self, plt, doctor):
        msg = r"No parameter named 'foo' could be found. " r"Use doctor.get_param_names\(\) to check all parameters."
